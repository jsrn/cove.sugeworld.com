...
A:hover { text-decoration: none; color:#c0c0c0 }
  ...
  <LINK REL=STYLESHEET HREF="tales/norm.css" TYPE="text/css">
</HEAD>
<BODY BGCOLOR="#000000" TEXT="#c0c0c0" LINK="#c0c0c0" VLINK="#c0c0c0" BACKGROUND="h">
<TABLE width="100%" cellspacing="2" cellpadding="2" border="0" class="notes">
  <TR>

    <TD valign="top"><IMG src="bocimages/navalchart.gif" border="0"
	  width="700">
      <P>
